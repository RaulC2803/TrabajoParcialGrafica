...
int main()
{
    ...
    read("OFF/triangulotex.off", figure, true, false);


    figure->registerFigure();
    figure->loadTexture("Textures/container.jpg");


    CProgramaShaders programShader = CProgramaShaders("GLSL/codigo.vs", "GLSL/codigo.fs");
